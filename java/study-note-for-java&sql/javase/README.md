...
| 项目 | 技术栈 | 练什么 |
|---|---|---|
| [javase-demo](demos/javase-demo/) | Java | 字节码反汇编、类型陷阱、OOP 多态、集合 + Stream |
...
进入下一台阶 👉 [javaee 分区](../javaee/README.md)：Servlet 原理 → 事务 / 并发 / 幂等 → Spring Boot 工程化。

---
*本分区与 `javaee/` 分区共同构成完整的 Java 学习阶梯：JavaSE → Java×SQL → SQL 工业实践 → JavaEE 服务端开发。*